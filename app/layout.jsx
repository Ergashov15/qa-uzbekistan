...
const banner = (
  <Banner storageKey="qa-journey-welcome">
    QA Journey — Dasturiy ta'minot sifatini ta'minlash (QA) bo'yicha ochiq manbali qo'llanma.
  </Banner>
)
...
const navbar = (
  <Navbar
    logo={
      <span style={{ display: 'flex', alignItems: 'center', gap: '8px', fontWeight: 700, fontSize: '18px' }}>
        <span style={{ backgroundColor: '#2563eb', color: '#fff', padding: '2px 8px', borderRadius: '4px', fontSize: '13px', fontWeight: 600, letterSpacing: '0.5px' }}>QA</span>
        <span>Journey</span>
      </span>
    }
