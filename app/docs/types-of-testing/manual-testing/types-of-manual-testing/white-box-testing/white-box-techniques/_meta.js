export default {
  ...
  'statement-coverage-testing': 'Operatorlar qamrovi sinovi (Statement Coverage Testing)',
  'decision-coverage-testing': 'Qarorlar qamrovi sinovi (Decision Coverage Testing)'
}
