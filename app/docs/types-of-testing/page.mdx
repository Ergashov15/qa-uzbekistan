...
<Cards num={2}>
  <Cards.Card
    icon={<ManualTestIcon />}
    title="Qo'lda Sinash (Manual Testing)"
...
<Cards num={2}>
  ...
  <Cards.Card
    icon={<AlphaTestIcon />}
    title="Alfa Sinov (Alpha Testing)"
...
<Cards num={2}>
  ...
  <Cards.Card
    icon={<SecurityTestIcon />}
    title="Xavfsizlik Sinovi (Security Testing)"
  ...
  <Cards.Card
    icon={<EnduranceTestIcon />}
    title="Bardoshlilik Sinovi (Endurance Testing)"
...
<Cards num={2}>
  ...
  <Cards.Card
    icon={<StrategyTestIcon />}
    title="Test Strategiyasi (Test Strategy)"
