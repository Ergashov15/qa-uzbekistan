...
<Cards num={2}>
  ...
  <Cards.Card
    title="▶️ 3. Gibrid Model (Hybrid Model in Software Testing)"
  ...
  <Cards.Card
    title="▶️ 4. Prototip Modeli (Prototype Model in Software Testing)"
  ...
  <Cards.Card
    title="▶️ 5. V-Model (V-Model in Software Testing)"
