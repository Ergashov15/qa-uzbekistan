...
<Cards num={2}>
  <Cards.Card
    title="▶️ 1. Sinov Asoslari (Fundamentals of Testing)"
  ...
  <Cards.Card
    title="🔄 2. SDLC da Sinov (Testing Throughout the SDLC)"
  ...
  <Cards.Card
    title="🛠️ 4. Sinov Tahlili va Loyihalash (Test Analysis and Design)"
  ...
  <Cards.Card
    title="📊 5. Sinov Faoliyatlarini Boshqarish (Managing the Test Activities)"
